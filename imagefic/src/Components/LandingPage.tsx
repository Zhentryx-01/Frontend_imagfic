...
<div className='z-20 flex justify-center pt-8 '>
    <img src={Zhentryx} alt="" className='w-52 md:w-80 h-24 md:h-32' />
            ...
            <div className='sub-section mt-64 relative text-white z-20 flex flex-col max-w-[700px] flex items-start justify-left leading-normal text-left max-w-4xl w-full px-4 md:px-12 lg:px-24  mt-16'
             >
